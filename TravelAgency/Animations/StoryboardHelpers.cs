...
namespace TravelAgency
{
    ...
    public static class StoryboardHelpers
    {
        ...
        {
            // Create the margin animation from bottom
            var animation = new ThicknessAnimation
            {
                Duration = new Duration(TimeSpan.FromSeconds(seconds)),
        ...
        /// <summary>
        /// Adds a slide to upwards animation to the storyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation</param>
        /// <param name="seconds">The time the animation will take</param>
        /// <param name"offset">The distance to the right to start from</param>
        /// <param name="decelerationRatio">The rate of deceleration</param>
        /// /// <param name="keepMargin">Whether to keep the element at the same width durin animation</param>
        public static void AddSlideToUpwards(this Storyboard storyboard, float seconds, double offset, float decelerationRatio = 0.9f, bool keepMargin = true)
        {
            // Create the margin animation from bottom
            var animation = new ThicknessAnimation
            {
